...
BASEURL:string="http://localhost:8082/api/";
  ...
  uploadcsv(data:any){
    return this.http.post("http://localhost:8082/csv/upload",data,{  responseType: 'text'});
  }

  uploadfile(data:any){
    // const headers = new HttpHeaders().set('Content-Type', 'text/plain; charset=utf-8');
    
    return this.http.post("http://localhost:8082/singleFileupload",data,{  responseType: 'text'});
  }
